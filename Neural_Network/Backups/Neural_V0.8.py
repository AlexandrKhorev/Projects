...
def graph_structure(total_weights, network_structure, x_input):
    plt.figure()
...
# graph_structure(total_weight, Neuron_Structure, x_test)
# print(forward_prop(x_test, total_weight, Neuron_Structure))
